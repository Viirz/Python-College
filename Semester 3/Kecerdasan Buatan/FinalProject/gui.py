...
# Buat instance dari class CleaningData
data = CleaningData()
...
def button_ayam_clicked():
    # Select 4 random rows from ayamdata
    random_rows = ayamdata.sample(4)
    ...
    button_result1.config(
        text=titles[0], font=("OpenSansRoman", 16, "bold"), fg="white",
        compound='center')
    button_result2.config(
        text=titles[1], font=("OpenSansRoman", 16, "bold"), fg="white",
        compound='center')
    button_result3.config(
        text=titles[2], font=("OpenSansRoman", 16, "bold"), fg="white",
        compound='center')
    button_result4.config(
        text=titles[3], font=("OpenSansRoman", 16, "bold"), fg="white",
        compound='center')
...
def button_kambing_clicked():
    # Select 4 random rows from ayamdata
    random_rows = kambingdata.sample(4)
...
def button_udang_clicked():
    # Select 4 random rows from ayamdata
    random_rows = udangdata.sample(4)
